...
<head>
    ...
    <!-- page css -->
    <link href="{{asset('Axton/assets')}}/css/pages/login-register-lock.css" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="{{asset('Axton/assets')}}/css/style.min.css" rel="stylesheet">
...
<body class="skin-default card-no-border">
    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">{{config('axton.loader')}}</p>
        </div>
    </div>
    <!-- ============================================================== -->
    ...
    <!-- ============================================================== -->
    <section id="wrapper">
        <div class="login-register" style="background-image:url({{asset('Axton/assets')}}/img/background/login-register.jpg);">
